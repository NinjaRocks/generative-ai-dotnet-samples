...
| [`04.3-persistent-session/`](04.3-persistent-session/) | 4.3.3 | `AgentThread` serialize/deserialize round trip. |
...
| [`04.7-a2a-server/`](04.7-a2a-server/) | 4.7.3 | `MapA2A` exposing a local agent over the A2A protocol. |
